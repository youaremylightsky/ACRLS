...
// Query to fetch user activity for all users from the database
$activityQuery = "SELECT * FROM user_activity ORDER BY timestamp DESC"; // Fetch activity for all users, ordered by timestamp
                        ...
                        <div class="card-body">
                            <table id="userActivityTable" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    if ($activityResult && $conn) {
                                        if ($activityResult->num_rows > 0) {
                                            while ($activityRow = $activityResult->fetch_assoc()) {
                                                echo "<tr>";
                                                // echo "<td>" . $activityRow['user_id'] . "</td>";
                                                echo "<td>" . $activityRow['activity'] . "</td>";
                                                echo "<td>" . $activityRow['timestamp'] . "</td>";
                                                echo "</tr>";
                                            }
                                        } else {
                                            echo "<tr><td colspan='3'>No user activity found</td></tr>";
                                        }
                                    } else {
                                        echo "<tr><td colspan='3'>Error fetching user activity</td></tr>";
                                    }
                                    ?>
                                </tbody>
                            </table>
